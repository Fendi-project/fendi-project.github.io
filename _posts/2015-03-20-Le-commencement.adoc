...
* Une motorisation avec des moteurs de chez Robotis (XL320, http://support.robotis.com/en/product/dynamixel/xl-series/xl-320.htm). Ce sont des moteurs performants, puissants et qui ont un chainage en série ce qui permet de réduire le nombre de câbles
